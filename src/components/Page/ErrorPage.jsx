...
const ErrorPage = () => {
    return (
        <div className={'flex flex-col justify-center items-center min-h-screen'}>
            ...
            <div>
                <img src={notFoundImg} alt='not found' className={'h-[12rem]'}/>
            </div>
            <div>
                <Link to={'/'}
                      className="relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-red-500 rounded-xl group mt-2">
                    <span
                    ...
                    <span
                        className="relative w-full text-left text-white transition-colors duration-200 ease-in-out group-hover:text-white">homepage</span>
                </Link>
            </div>
